...
function centerContent() {
  ...
  getContentElement().style.top =
    Math.max(0, (a - getContentElement().offsetHeight) / 2 + getScrollTop()) +
    "px";
  getContentElement().style.left =
    Math.max(0, (b - getContentElement().offsetWidth) / 2 + getScrollLeft()) +
    "px";
}
function r(a) {
...
function compileContent() {
  var b = {
    ...
    cv: '<a href="resume.pdf">📄</a>',
    experience: ,
    [
    {
      company: "Green Key Resources",
      position: "Software Engineer",
      specialties: ["Javascript", "Azure Cloud Services", "Salesforce LWC", "API Development"],
    },
      {
      company: "HiringSolved",
      position: "Software Engineer",
      specialties: ["Typescript", "Python", "React", "Google Cloud Suite"],
    }
  ],
    education: [
      {
    ...
    projects: ['<a href="https://github.com/austinbkillo">github</a>'],
    contact: [
      '<a href="mailto:austinbkillough@gmail.com">email</a>',
      '<a href="https://www.linkedin.com/in/austin-killough">linkedin</a>',
    ],
  };
  return (
    "<pre id='" +
    contentId +
    "'>" +
    JSON.convertToHumanReadableString(
      b,
      2,
